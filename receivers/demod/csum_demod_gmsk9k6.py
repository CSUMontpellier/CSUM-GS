...
# Author: CSUM
# Copyright: CSUM
# Description: Demodulates signals from CSUM satellites in GMSK 9600 bps and deframe their AX.25 packets.
...
import csum_demod_gmsk9k6_epy_block_0 as epy_block_0  # embedded python block
import satellites.components.deframers


def snipfcn_snippet_0(self):
    print("\033[38;5;70mDemodulator GMSK9k6 started.\033[0m")
...
class csum_demod_gmsk9k6(gr.top_block):

    def __init__(self, iqs_file_path="", throttle_test=153600):
        gr.top_block.__init__(self, "GMSK9k6 demodulator and AX.25 deframer for CSUM satellites.", catch_exceptions=True)
        ...
        self.demod_samp_rate = demod_samp_rate = 19200
        ...
        self.connect((self.analog_quadrature_demod_cf_0_0, 0), (self.digital_symbol_sync_xx_0, 0))
    ...
    def set_in_samp_rate(self, in_samp_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.in_samp_rate, (self.baudrate*1), 0.35, (self.in_samp_rate//self.baudrate*8)))
...
def main(top_block_cls=csum_demod_gmsk9k6, options=None):
    if options is None:
